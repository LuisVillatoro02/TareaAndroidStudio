...
public class ListarProductoList extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(getApplicationContext(),"Mostrando Datos", Toast.LENGTH_LONG).show();
        } catch (Exception e) {
            Toast.makeText(getApplicationContext(),"No se puede Mostrar",Toast.LENGTH_LONG).show();
        }
    }
